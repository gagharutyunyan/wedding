...
export const Video = () => {
    const [widthHeight, setWithHeight] = useState({
        ...
        <div className="video_container">
            ...
            <div className="video_content">
                <div className="video_content_title">
                    <span className="video_content_title_1 outfit">Gagik</span>
                    <span className="video_content_title_2 great">and</span>
                    <span className="video_content_title_3 outfit">Jessica</span>
                </div>
